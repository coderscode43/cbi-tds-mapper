...
const Deposit = () => {
   ...
   const handleSearchParamChange = (e) => {
      ...
      navigate(`/home/listSearch/deposit/${refinedParams}`);
   };
   ...
   return (
      <>
         <div className="custom-scrollbar space-y-5">
            <h1 className="mb-4 text-[25px] font-medium">Deposit</h1>
               ...
               <div className="flex items-end justify-between gap-4">
                  <div className="flex w-full gap-5">
                     ...
                     <SelectField
                        ...
                        name="typeOfForm"
                        options={typeOfForm}
                        value={parsedParams.typeOfForm || ""}
                        onChange={(value) =>
                           handleSearchParamChange({
                              target: {name: "typeOfForm", value},
                           })
                        }
                     />
                  </div>
                     ...
                     <TabList className="flex gap-3">
                        {categories?.map(({name, panelName}) => (
                           <Tab
                              key={panelName}
                              className={({selected}) =>
                                 `w-full cursor-pointer rounded-md px-4 py-3 font-medium transition-all duration-300 ${
                                    selected
            ...
            <div className="flex justify-between rounded-md border border-gray-100 bg-white p-6 shadow-lg">
               ...
               <div className="space-y-5">
                  ...
                  <button
                     onClick={() => handleProcessButtonClick("AppendS.DOnTransaction")}
                     className="flex cursor-pointer items-center gap-3 rounded-md border border-blue-200 bg-blue-50 px-3 py-2 font-medium shadow-sm transition-all duration-300 hover:bg-blue-100 hover:shadow-md"
                  >
                     <img
                        ...
                        className="h-7 w-7 mix-blend-multiply"
                     />
                     <span>Append S.D On Transaction</span>
                  </button>
               </div>
               ...
               <div className="space-y-5">
                  <button
                     onClick={() =>
                        handleProcessButtonClick("GetPreviousMonthTDSDump")
                     }
                     className="flex cursor-pointer items-center gap-3 rounded-md border border-blue-200 bg-blue-50 px-3 py-2 font-medium shadow-sm transition-all duration-300 hover:bg-blue-100 hover:shadow-md"
                  >
                     <img
               ...
               <div className="space-y-5">
                  ...
                  >
                     <img
                        ...
                        className="h-7 w-7 mix-blend-multiply"
                     />
                     <span>Get Overall Amount & Calculated S.D</span>
                  </button>

                  <button
                     onClick={() => handleProcessButtonClick("UploadData")}
                     className="flex cursor-pointer items-center gap-3 rounded-md border border-blue-200 bg-blue-50 px-3 py-2 font-medium shadow-sm transition-all duration-300 hover:bg-blue-100 hover:shadow-md"
                  >
                     <img
                        src={`${import.meta.env.BASE_URL}/images/gificons/Excelfile.gif`}
            ...
            <div className="flex justify-between rounded-md border border-gray-100 bg-white p-6 shadow-lg">
               ...
               <div className="space-y-5">
                  <button
                     onClick={() =>
                        handleProcessButtonClick("DownloadCurrentMonthData")
                     }
                     className="flex cursor-pointer items-center gap-3 rounded-md border border-blue-200 bg-blue-50 px-3 py-2 font-medium shadow-sm transition-all duration-300 hover:bg-blue-100 hover:shadow-md"
                  >
                     <img
